...
async function pickFolderUnlocked() {
...
function parseSelectedPath(stdout) {
...
function runPicker(command, args) {
    return new Promise((resolve, reject) => {
        let child;
        try {
            child = (0, node_child_process_1.spawn)(command, args, { windowsHide: true, stdio: ['ignore', 'pipe', 'pipe'] });
        }
        catch (error) {
